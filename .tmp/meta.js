import ColorfulButtonMeta from '/Users/hdj/Desktop/github/dj-material-test/lowcode/colorful-button/meta'
import ColorfulInputMeta from '/Users/hdj/Desktop/github/dj-material-test/lowcode/colorful-input/meta'
import DjButtonMeta from '/Users/hdj/Desktop/github/dj-material-test/lowcode/dj-button/meta'
...
function fillRealVersion(meta, packageName = 'dj-material-test', version = '0.1.0', basicLibraryVersion={"@alifd/next":"1.25.23","@alifd/meet":"2.6.3","antd":"4.17.3"}) {
  if (!meta || !version) {
    return meta;
  }
  const { npm } = meta;
...
const componentMetas = [ColorfulButtonMeta,ColorfulInputMeta,DjButtonMeta];
const components = [];
const npmInfo = {};
...
if (!execCompile) {
  window.DjMaterialTestMeta = { components, componentList };
}